...
if (is_file(__DIR__ . 'vendor/autoload.php') && is_readable(__DIR__ . 'vendor/autoload.php')) {
    require_once __DIR__.'vendor/autoload.php';echo "found autoload";
} else {
...
if (file_exists('vendor/settings.php')) {
    include 'vendor/settings.php';echo "found settings";
}
...
$default_upload_options = array('tags' => 'crma');
$eager_params = array('width' => 200, 'height' => 150, 'crop' => 'scale');
if(isset($_FILES['record_image'])){
  $files = $_FILES['record_image'];
}
...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
      <tr><td colspan="2">แนบรูปภาพ<input type='file' name='record_image' class='form-control' /></td></tr>
        <tr><td colspan="2" align="center"><input type='submit' value='Save' class='btn btn-primary' /></td></tr>
        </table>
      </form>
<?php
    show_image(
