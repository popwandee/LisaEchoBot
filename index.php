              ...
              <div class="col-sm-4">
                <div class="panel panel-success">
                  ...
                  <div class="panel-body">
                    ...
                    <span class="list-group-item">คงเหลือ <?php $sum=number_format($sum, 2);echo $sum;?> บาท</span>
                  </div>
                </div>
              </div><!-- /.col-sm-4 -->
              <div class="col-sm-4">
...
function show_10_request(){
  $q = '?s={"date":-1}&sk=0&l=10';
    $url= "https://api.mlab.com/api/1/databases/crma51/collections/request".$q."&apiKey=".MLAB_API_KEY;
